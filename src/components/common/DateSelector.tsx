      ...
      >
        ...
        <div
          className={`
            ...
            bg-gradient-to-r from-[var(--color-accent-violet)]/80 to-[color-mix(in_srgb,var(--color-accent-violet)_80%,black)]/80
            rounded-xl shadow-[0_8px_25px_color-mix(in_srgb,var(--color-accent-violet)_35%,transparent)]
        ...
        >
          ...
          <div className="flex flex-col items-start z-10">
            <span className="text-[10px] font-black text-[var(--color-accent-violet)]/90 uppercase tracking-wider mb-0.5 drop-shadow">
              {month}
            </span>
          ...
          <div className="z-10 pointer-events-none">
            <svg
              className="w-6 h-6 text-[var(--color-accent-cyan)] opacity-90"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        <div className="mt-1 text-[9px] font-black uppercase text-[var(--color-accent-violet)]/70 text-center tracking-[0.12em] opacity-90 drop-shadow">
          Changer Date
        </div>
      </div>
    );

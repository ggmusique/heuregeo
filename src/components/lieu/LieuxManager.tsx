            ...
            <div className="mt-2 space-y-1">
              ...
              {backfillResult.errors.map((e, i) => (
                <div key={i} className="flex items-center gap-2">
                  ...
                  <button onClick={() => onLieuEdit(lieux.find((l) => l.id === e.id))} aria-label="Modifier ce lieu" className="inline-flex items-center gap-1 text-[10px] font-black uppercase text-purple-300 hover:text-purple-100 transition-all">

    ...
    <article 
      ...
      onKeyDown={(e) => {
        if (e.key === 'Enter' || e.key === ' ') {
          ...
          setTimeout(() => e.currentTarget.style.transform = 'translateY(0)', 150);
        }
      }}
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '14px' }}>
        <div style={{
          ...
          fontSize: '16px', border: `1px solid ${color.glow}`,
        ...
        <span style={{
          ...
          color: tokens.colors.text.muted, fontWeight: 700, lineHeight: 1.2
        }}>
          {label}
        </span>
      </div>
      ...
      <div style={{
        ...
        fontSize: '24px', fontWeight: 600, color: color.primary,

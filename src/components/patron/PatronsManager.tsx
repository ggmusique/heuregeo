                ...
                {isExpanded && (
                  <div className={`px-5 pb-5 animate-in slide-in-from-top-2 duration-200 ${darkMode ? "bg-black/20" : "bg-white/50"}`}>
                    ...
                    <div className="flex gap-2">
                      <button onClick={() => onEdit(patron)} className={`flex-1 py-3 rounded-xl font-black uppercase text-[10px] transition-all ${darkMode ? "bg-blue-600/20 text-blue-400 border border-blue-500/30" : "bg-blue-100 text-blue-700 border border-blue-300"} active:scale-95`}>✏️ Modifier</button>
                      <button onClick={() => onDelete(patron)} className={`flex-1 py-3 rounded-xl font-black uppercase text-[10px] transition-all ${darkMode ? "bg-red-600/20 text-red-400 border border-red-500/30" : "bg-red-100 text-red-700 border border-red-300"} active:scale-95`}>🗑️ Supprimer</button>
                    </div>
                  </div>
                )}
              </div>

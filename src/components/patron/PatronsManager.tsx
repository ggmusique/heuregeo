                    ...
                    <div className="flex gap-2">
                      ...
                      {!isViewer && ownerProfile && patron.email && (
                        <button
                          ...
                          className="px-3 h-10 rounded-xl flex items-center gap-1.5 transition-[background] duration-150 active:scale-90 bg-[var(--color-accent-violet)]/15 text-[var(--color-accent-violet)] border border-[var(--color-accent-violet)]/30 hover:bg-[var(--color-accent-violet)]/25 text-[10px] font-black uppercase tracking-wider disabled:opacity-50"
                        >
                          {patronAccessHook.inviting === patron.id ? (
                            <div className="w-3 h-3 rounded-full border border-[var(--color-accent-violet)] border-t-transparent animate-spin" />
                          ) : (

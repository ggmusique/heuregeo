...
const patronNameStyle = { ...tokens.text.badge, color: "var(--color-text-muted)" };
      ...
      <div style={actionsContainerStyle}>
        ...
        {(onEdit || onDelete) && (
          <div style={buttonGroupStyle}>
            <button type="button" onPointerDown={handleEdit} onClick={handleEdit} style={btnEditStyle} aria-label="Modifier mission" title="Modifier">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/>
                <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>
              </svg>
            </button>
            <button type="button" onPointerDown={handleDelete} onClick={handleDelete} style={btnDeleteStyle} aria-label="Supprimer mission" title="Supprimer">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">

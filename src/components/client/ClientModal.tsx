...
export const ClientModal = ({
  ...
  return (
      <div className="fixed inset-0 z-[500] flex items-center justify-center p-6 bg-[var(--color-overlay)] backdrop-blur-overlay">
        <div
          className="w-full max-w-md p-6 rounded-[30px] max-h-[calc(100vh-8rem)] overflow-y-auto bg-[var(--color-surface)] border-2 border-[var(--color-border)] shadow-modal"
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-4 rounded-2xl font-bold outline-none border-2 transition-[border-color,background-color] duration-150 bg-[var(--color-bg-input)] border-[var(--color-border)] text-[var(--color-text)] focus:border-[var(--color-accent-violet)] placeholder:text-[var(--color-text-dim)]"
              required
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full p-4 rounded-2xl font-bold outline-none border-2 transition-[border-color,background-color] duration-150 resize-none bg-[var(--color-bg-input)] border-[var(--color-border)] text-[var(--color-text)] focus:border-[var(--color-accent-violet)] placeholder:text-[var(--color-text-dim)]"
            />
          </div>

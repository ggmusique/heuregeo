...
/**
 * AppNavBar — Barre de navigation du bas.
 *
 * Deux modes :
 * - Pro : icônes + labels compacts (4-5 onglets)
 * - Standard : boutons texte plus grands (3-4 onglets)
 */
export function AppNavBar({ activeTab, setActiveTab, proNavItems }) {
  const { darkMode, isPro, isViewer, canDashboard } = useApp();
      ...
      {isProNavigationMode ? (
        <div
          className={
            ...
            (darkMode
              ? "bg-[#030d22]/95 border-yellow-500/30"

...
// ─── Types des callbacks paramètres ──────────────────────────────────────────

type OnSuccessFn = (address: string, lat: number, lng: number) => void;
...
export const useGeolocation = (
  ...
  const [position, setPosition] = useState<GeoPosition>({ lat: null, lng: null });

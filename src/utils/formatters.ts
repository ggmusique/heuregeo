 ...
 *   1234.5 => "1 234,50 €"
 */
export const formatEuro = (num: number): string => {
 ...
 *   8.5 => "8,50 h"
 */
export const formatHeures = (num: number): string => {
  if (typeof num !== "number" || isNaN(num)) {
    return "0,00 h";
  }
 ...
 *   75.456 => "75,5 %"
 */
export const formatPourcent = (num: number, decimals: number = 1): string => {
  if (typeof num !== "number" || isNaN(num)) {
    return "0 %";
  }
 ...
 *   12 => "Semaine 12"
 */
export const formatSemaine = (weekNum: number): string => {
